...
def is_sufficient_resource(order_ingredients):
    """Returns True when enough ingredients are on hand and False when ingredients are not sufficient"""
...
def process_coins():
    """function returns values of total coins inserted"""
...
def make_coffee(drink_name, order_ingredients):
    """Deduct the rquired ingredients from resources"""
    for item in order_ingredients:
